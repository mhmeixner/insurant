    ...
    <div id="page">
        ...
        <header id="header" role="banner" class="clearfix">
            ...
            <?php if ($page['header_bottom']): ?>
                <div class="section-4 clearfix">
                    <div class="container-12">
                        <div class="grid-12"><?php print render($page['header_bottom']); ?></div>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div id="main-wrapper">
            ...
            <?php if ($page['content_top']): ?>
                <div class="container-12">
                    <div class="grid-12"><?php print render($page['content_top']); ?></div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($page['content_bottom']): ?>
                <div class="section-5 clearfix">
                    <div class="container-12">
                        <div class="grid-12"><?php print render($page['content_bottom']); ?></div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="container-12">
                <div class="grid-12">
                    <div class="footer-wrapper clearfix">
                        ...
                        <?php if ($is_front): ?>More <a rel="nofollow" href="http://www.templatemonster.com/category/insurance-drupal-themes/" target="_blank">Insurance Drupal Themes at TemplateMonster.com</a><?php endif; ?>
                    </div>
                </div>
            </div>
        </footer>
